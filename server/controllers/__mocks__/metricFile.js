...
const metricFileNoType = `
<?xml version="1.0" encoding="utf-8"?>
<issues>
  <issue level="0" display="yes" name="Terminology" weight="1">
    <issue type="term-inconsistency" level="1" display="yes" name="inconsistent use of terminology" weight="1">
      <issue type="multiple-translations-of-term" level="2" display="yes" name="multiple terms in translation" weight="1" />
    </issue>
    <issue type="wrong-term" level="1" display="yes" name="wrong term" weight="1" />
...
const metricFileNoDisplay = `
<?xml version="1.0" encoding="utf-8"?>
<issues>
  <issue type="terminology" level="0" name="Terminology" weight="1">
    <issue type="term-inconsistency" level="1" display="yes" name="inconsistent use of terminology" weight="1">
      <issue type="multiple-translations-of-term" level="2" display="yes" name="multiple terms in translation" weight="1" />
    </issue>
    <issue type="wrong-term" level="1" display="yes" name="wrong term" weight="1" />
...
module.exports = (error = '') => ({
  data: {
    toString() {
      if (error === 'issues') {
        return metricFileNoIssues;
      }

      if (error === 'type') {
        return metricFileNoType;
      }

      if (error === 'display') {
        return metricFileNoDisplay;
      }

      if (error === 'level') {
        return metricFileTooDeep;
      }
      if (error === 'empty') {
        return '';
      }

      return validMetricFile;
    },
  },
});
